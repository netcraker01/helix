...
pub fn build_app() -> tauri::Builder<tauri::Wry> {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::ipc::commands::get_cached_artist_detail,
            crate::ipc::commands::refresh_artist_detail,
            crate::ipc::commands::get_stale_favorite_artist_ids,
            ...
            // Focus lifecycle, recovery, preferences, history, and playback acknowledgements
            ...
            crate::ipc::commands::start_remote_fft,
